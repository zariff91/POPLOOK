...
public class customerServiceAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolder> {
    ...
    ArrayList<customerServiceItem> data ;
    ...
    public customerServiceAdapter(ArrayList<customerServiceItem> data1){ // MyAdapter Constructor with titles and icons parameter
